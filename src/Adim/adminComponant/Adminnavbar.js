...
export default function Adminnavbar() {
    ...
    return (
        <>
            <div class="sb2-12">
                <ul>
                    <li><img src="images/placeholder.PNG" alt="" />
                    </li>
                    <li>
                        <h5>Libraria<span>Vaish College Of Engineering</span></h5>
                    </li>
                    <li></li>
                </ul>
            </div>
            ...
            <div class="sb2-13">
                <ul data-collapsible="accordion">
                    ...
                    <li><a href="/Eventadddata"><i class="fa fa-cogs" aria-hidden="true"></i>Add Events</a>
                    </li>
                    ...
                    <li><Link to="/" ><i class="fa fa-user" aria-hidden="true"></i>LogOut</Link></li>
